...
@section('main')
    ...
    <section id="carouselExampleIndicators" class="carousel slide mb-5" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src={{ asset('./img/p-1.jpg') }} class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src={{ asset('./img/p-2.jpg') }}  class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src={{ asset('./img/p-3.jpg') }}  class="d-block w-100" alt="...">
            </div>
        </div>
                ...
                <div class="row d-flex justify-content-center mx-auto">
                    <div class="col-md-4  col-lg-3">
                        <div class=" lightblue mx-auto rounded-circle d-flex justify-content-center align-items-center"
                            ...
                            <img src="{{ asset('./img/svg-export/svgexport-4.svg') }}" alt="">
                        </div>
                    ...
                    <div class="col-md-4  col-lg-3">
                        <div class=" lightblue mx-auto rounded-circle d-flex justify-content-center align-items-center"
                            style="width: 80px; height: 80px;">
                            <img src="{{ asset('./img/svg-export/svgexport-6.svg') }}" alt="">
                        </div>
                        <div class="card-body text-center">
                    ...
                    <div class="col-md-4  col-lg-3">
                        <div class=" lightblue mx-auto rounded-circle d-flex justify-content-center align-items-center"
                            style="width: 80px; height: 80px;">
                            <img src="{{ asset('./img/svg-export/svgexport-7.svg') }}" alt="">
                        </div>
                        <div class="card-body text-center">
        ...
        <div class="col-lg-10 d-flex pt-5 mx-auto">
            <div class="col-6 px-0">
                <div class="col d-flex px-0">
                    <img class="col-6 px-1 px-md-3" src="{{ asset('./img/photo/500x300.png') }}" alt="">
                    <img class="col-6 px-1 px-md-3" src="{{ asset('./img/photo/501x301.png') }}" alt="">
                </div>
                <img class="col pt-2 pt-md-4 px-1 px-md-3" src="{{ asset('./img/photo/601x361.png') }}" alt="">
            </div>
            <div class="col-6 px-0">
                <img class="col pb-2 pb-md-4 px-1 px-md-3" src="{{ asset('./img/photo/600x360.png') }}" alt="">
                <div class="col d-flex px-0">
                    <img class="col-6 px-1 px-md-3" src="{{ asset('./img/photo/502x302.png') }}" alt="">
                    <img class="col-6 px-1 px-md-3" src="{{ asset('./img/photo/503x303.png') }}" alt="">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="d-lg-flex p-md-5  justify-content-center">
            <div class="d-md-flex col-lg-5 mb-4">
                <div class="col col-md-6 col-lg-6 card pt-4 px-4 mx-auto" style="width: 34rem;">
                    <img src="{{ asset('./img/photo/720x400.png') }}" class="card-img-top" alt="...">
                ...
                <div class="col col-md-6 col-lg-6 card pt-4 px-4 mx-auto mx-md-3" style="width: 34rem;">
                    <img src="{{ asset('./img/photo/721x401.png') }}" class="card-img-top" alt="...">
                    <div class="card-body px-0">
                        <h6 class="card-subtitle mb-2" style="color: #6366F1;">SUBTITLE</h6>
            ...
            <div class="d-md-flex col col-lg-5 mb-4">
                <div class="col col-md-6 col-lg-6 card pt-4 px-4 mx-auto" style="width: 34rem;">
                    <img src="{{ asset('./img/photo/722x402.png') }}" class="card-img-top" alt="...">
                    <div class="card-body px-0">
                        <h6 class="card-subtitle mb-2" style="color: #6366F1;">SUBTITLE</h6>
                ...
                <div class="col col-md-6 col-lg-6 card pt-4 px-4 mx-auto mx-md-3" style="width: 34rem;">
                    <img src="{{ asset('./img/photo/723x403.png') }}" class="card-img-top" alt="...">
                    <div class="card-body px-0">
                        <h6 class="card-subtitle mb-2" style="color: #6366F1;">SUBTITLE</h6>
    ...
    <section class="col col-lg-6 mx-auto">
        <div class="col d-md-flex py-5 justify-content-between">
            <div class=" lightblue mx-auto rounded-circle d-flex justify-content-center align-items-center"
                ...
                <img src="{{ asset('./img/svg-export/svgexport-9.svg') }}" alt="">
            </div>
        ...
        <div class="d-md-flex flex-row-reverse py-5 ">
            <div class=" lightblue mx-auto rounded-circle d-flex justify-content-center align-items-center"
                style="min-width: 128px; max-width: 128px; height: 128px;">
                <img src="{{ asset('./img/svg-export/svgexport-11.svg') }}" alt="">
            </div>
            <div class="col col-md-10">
                <h5 class="card-title font-weight-normal">Shooting Stars</h5>
                <p class="card-text">Blue bottle crucifix vinyl post-ironic four dollar toast vegan
        ...
        <div class="col d-md-flex py-5">
            <div class=" lightblue mx-auto rounded-circle d-flex justify-content-center align-items-center"
                style="min-width: 128px; max-width: 128px; height: 128px;">
                <img src="{{ asset('./img/svg-export/svgexport-12.svg') }}" alt="">
            </div>
            <div class="col-md-10">
                <h5 class="card-title font-weight-normal">Shooting Stars</h5>
                <p class="card-text">Blue bottle crucifix vinyl post-ironic four dollar toast vegan
    ...
    <section class="py-5 d-lg-flex flex-wrap justify-content-center">
        <div class="col-12 col-md-10 col-lg-5 pt-5 d-md-flex mx-auto mx-lg-0">
            <div class="col-12 col-md-6 col-lg-6">
                <img src="{{ asset('./img/photo/420x260.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col-12 col-md-6 col-lg-6">
                <img src="{{ asset('./img/photo/421x261.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <p class="card-text"><small class="text-muted">CATEGORY</small></p>
        ...
        <div class="col-12 col-md-10 col-lg-5 pt-5 d-md-flex mx-auto mx-lg-0">
            <div class="col-12 col-md-6 col-lg-6">
                <img src="{{ asset('./img/photo/422x262.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <p class="card-text"><small class="text-muted">CATEGORY</small></p>
            ...
            <div class="col-12 col-md-6 col-lg-6">
                <img src="{{ asset('./img/photo/423x263.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <p class="card-text"><small class="text-muted">CATEGORY</small></p>
        ...
        <div class="col-12 col-md-10 col-lg-5 pb-5 d-md-flex mx-auto mx-lg-0">
            <div class="col-12 col-md-6 col-lg-6">
                <img src="{{ asset('./img/photo/424x264.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <p class="card-text"><small class="text-muted">CATEGORY</small></p>
                    <h5 class="card-title">The Catalyzer</h5>
                    <p class="card-text">$16.00</p>
            ...
            <div class="col-12 col-md-6 col-lg-6">
                <img src="{{ asset('./img/photo/425x265.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <p class="card-text"><small class="text-muted">CATEGORY</small></p>
                    <h5 class="card-title">Shooting Stars</h5>
                    <p class="card-text">$21.15</p>
        ...
        <div class="col-12 col-md-10 col-lg-5 pb-5 d-md-flex mx-auto mx-lg-0">
            <div class="col-12 col-md-6 col-lg-6">
                <img src="{{ asset('./img/photo/427x267.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <p class="card-text"><small class="text-muted">CATEGORY</small></p>
                    <h5 class="card-title">Neptune</h5>
                    <p class="card-text">$12.00</p>
            ...
            <div class="col-12 col-md-6 col-lg-6">
                <img src="{{ asset('./img/photo/428x268.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <p class="card-text"><small class="text-muted">CATEGORY</small></p>
                    <h5 class="card-title">The 400 Blows</h5>
                    <p class="card-text">$18.40</p>
    ...
    <section class="pb-5">
        <div class="mb-3 col-lg-8 mx-auto d-md-flex">
            <img class="col-lg-6" src="{{ asset('./img/photo/400x400.png') }}" alt="...">
            <div class="col-lg-6">
                <p class="card-text pt-3"><small class="text-muted">BRAND NAME</small></p>
                <h2 class="card-title ">The Catcher in the Rye</h2>
                <div class="d-flex">
                    <div class="border-right pr-3">
                        <img src="{{ asset('./img/svg-export/svgexport-13.svg') }}" alt="">
                        <img src="{{ asset('./img/svg-export/svgexport-13.svg') }}" alt="">
                        <img src="{{ asset('./img/svg-export/svgexport-13.svg') }}" alt="">
                        <img src="{{ asset('./img/svg-export/svgexport-13.svg') }}" alt="">
                        <img src="{{ asset('./img/svg-export/svgexport-14.svg') }}" class="mr-2" alt="">
                        <span class="h5">4 Reviews</span>
                    </div>
                    <div class="pl-3">
                        <img src="{{ asset('./img/svg-export/svgexport-15.svg') }}" alt="">
                        <img src="{{ asset('./img/svg-export/svgexport-16.svg') }}" alt="">
                        <img src="{{ asset('./img/svg-export/svgexport-17.svg') }}" alt="">
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="rounded-circle text-center"
                            ...
                            <img src="{{ asset('./img/svg-export/svgexport-19.svg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
